...
const Contact = () => {
    ...
    return (
        <>
            {/* ── Hero ─────────────────────────────────────── */}
            <section className="contact-hero" style={heroBgStyle}>
                ...
                <div className="contact-hero-content">
                    ...
                    <p className="contact-hero-subtitle">
                        {settings?.contactSubtitle ||
                            'Get in touch with our team for support, styling queries, or general feedback.'}
                    </p>
                </div>
            </section>
            ...
            <section className="contact-section">
                <div className="contact-inner-container">
                    <div className="contact-grid-layout">
                        ...
                        {/* ── Left: Info Cards ─── */}
                        <div className="contact-info-col-premium">
                            <span className="section-tag">[ Get in Touch ]</span>
                            <h2 className="contact-section-title-premium">
                                Visit our spaces or drop a message.
                            </h2>
                            <p className="contact-section-desc-premium">
                            ...
                            <div className="contact-info-cards-list-premium">
                                    ...
                                    <div className="info-card-text-premium">
                                        ...
                                        <p>
                                            {settings?.contactAddress ||
                                                'Styleora India Pvt Ltd., 4th Floor, Retail Hub, MG Road, Bangalore, Karnataka - 560001'}
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="contact-info-card-premium">
                                    ...
                                    <div className="info-card-text-premium">
                                        <h3>Support Email</h3>
                                        <p>
                                            <a href={`mailto:${settings?.contactEmail || 'support@styleora.in'}`}>
                                ...
                                <div className="contact-info-card-premium">
                                    ...
                                    <div className="info-card-text-premium">
                                        ...
                                        <p>
                                            <a href={`tel:${settings?.contactPhone || '+918040004000'}`}>
                        ...
                        {/* ── Right: Contact Form ─── */}
                        <div className="contact-form-col-premium">
                            <div className="contact-form-glass-card-premium">

                                {/* Response Badge */}
                                <div className="contact-response-badge-premium">
                                    <span className="badge-pulsing-dot-contact-premium" />
                                    <span className="response-badge-text-premium">
                                ...
                                <form className="contact-form-premium" onSubmit={handleSubmit}>
                                    <div className="form-group-premium mb-4">
                                        <label htmlFor="contact-name" className="contact-field-label-premium">
                                            Full Name
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="form-group-premium mb-4">
                                        <label htmlFor="contact-email" className="contact-field-label-premium">
                                            E-mail Address
                                        </label>
                                        <input
                                            type="email"
                                    ...
                                    <div className="form-group-premium mb-4">
                                        <label htmlFor="contact-subject" className="contact-field-label-premium">
                                            Subject
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="form-group-premium mb-4">
                                        <label htmlFor="contact-message" className="contact-field-label-premium">
                                            Your Message
                                        </label>
                                        <textarea
                                            id="contact-message"
